...
###add(otherVector) &rarr; [Vector4](page.php?p=5809)
...
###subtractFromFloatsToRef(x, y, z, w, result) &rarr; [Vector4](page.php?p=5809)
...
###static Maximize(left, right) &rarr; [Vector4](page.php?p=5809)
