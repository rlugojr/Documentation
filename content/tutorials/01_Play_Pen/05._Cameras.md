...
In any Babylon.js scene, you can create as many cameras as you wish, but only one camera can be active at a time (unless you are using [multi-viewports](http://babylondoc.azurewebsites.net/page.php?p=22461)).

Camera management in Babylon.js is pretty simple. Babylon.js supports many types of cameras. We will begin with the two most-common types - the FreeCamera and the ArcRotateCamera.
...
It's beautiful, it's easy, it's Babylon.js. Please see the  [ArcRotateCamera API page](http://babylondoc.azurewebsites.net/page.php?p=23874) for more information.


Both of these basic Babylon.js cameras will automatically handle inputs for you... once you call the camera's _attachControl_ function. And you can revoke the control by using the _detachControl_ function. Most Babylon.js experts use a two-step process to activate and attach a camera:
...
```
This activate-and-attach code is also used for our unique purpose cameras, which we will now talk about.
...
```
The TouchCamera uses a FreeCamera as its basis, so all the powerful properties and methods of our familiar FreeCamera... are also found on our TouchCamera. You can explore all the properties and methods available on the TouchCamera... at [**our API documentation site**](http://babylondoc.azurewebsites.net/page.php?p=23886).
...
We have a [special tutorial dedicated to the VirtualJoysticksCamera](http://babylondoc.azurewebsites.net/page.php?p=22502).

You can explore all the properties and methods available on the VirtualJoysticksCamera... at [**our API documentation site**](http://babylondoc.azurewebsites.net/page.php?p=23887).
...
Easy. Many of the powerful properties and methods found on our familiar FreeCamera... are also found on our GamepadCamera. Take notice of the ._angularSensibility_ and ._moveSensibility_ properties, similar to our DeviceOrientationCamera. You can explore all the properties and methods available on the GamepadCamera... at [our API documentation site](http://babylondoc.azurewebsites.net/page.php?p=23881).
...
As a last reminder, Babylon.js cameras require you to use “attachControl” and “detachControl” functions, as needed. Most Babylon.js experts... use a two-step process to activate and attach a camera:
...
You already knew about activating and attaching cameras, didn't you? You remembered from the last time I told you, right? :)

## Next step
You have now learned how to use the two most-common cameras, and you have been introduced to all of our innovative 'unique purpose' cameras. You can control how you see your scene, you can choose your input and viewing devices, and you now know how to move cameras around. To give your scene a more realistic effect, we are now going to learn [**how to manage lights**](http://babylondoc.azurewebsites.net/page.php?p=22071). See you soon.