...
Now you should know everything about collisions, so it’s time to move on to a classic effect in 3D : [particles](http://babylondoc.azurewebsites.net/page.php?p=22121).