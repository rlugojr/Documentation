...
All tags added to meshes, cameras, lights... are saved to the scene files (see [.babylon file format](https://github.com/BabylonJS/Babylon.js/wiki/Babylon.js-file-format)) and reloaded from them.
